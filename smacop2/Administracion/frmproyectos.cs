...
namespace smacop2.Administracion
{
    public partial class frmproyectos : Form
    {
        ...
        public frmproyectos(string id):this()
        {
            _id = id;
                ...
                if (e.ColumnIndex >= 0)
                {
                    ...
                    if (this.dataGridView1.Columns[e.ColumnIndex].Name == "Column1")
                    {
                        ...
                        if (a == 6)
                        {
                            ...
                            c.idproy = row.Cells[1].Value.ToString();

                            op_proyectos.accion(c, 3);
        ...
        //private Entity.empleados empleadosel { get; set; }
        ...
        private void toolStripTextBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
                toolStripButton6_Click_1(toolStripButton6, e);
        }
        ...
        private void toolStripTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F1)
                dataGridView1.DataSource = op_proyectos.GellAllproyectos2(toolStripTextBox1.Text + "%", 1);
            if (e.KeyCode == Keys.F2)
                dataGridView1.DataSource = op_proyectos.GellAllproyectos2(toolStripTextBox1.Text + "%", 2);
            if (e.KeyCode == Keys.F3)
                dataGridView1.DataSource = op_proyectos.GellAllproyectos2(toolStripTextBox1.Text + "%", 3);
            if (e.KeyCode == Keys.F4)
                dataGridView1.DataSource = op_proyectos.GellAllproyectos2(toolStripTextBox1.Text + "%", 4);
            if (e.KeyCode == Keys.F5)
                dataGridView1.DataSource = op_proyectos.GellAllproyectos2(toolStripTextBox1.Text + "%", 5);
        ...
        {
            DataGridViewRow row = dataGridView1.CurrentRow as DataGridViewRow;
            frmproyectosdet frm = new frmproyectosdet(row.Cells["cod"].Value.ToString(),null);
            ...
            //    this.empleadosel = op_empleados.GellIdempleados(Id);

            //    if (this.empleadosel != null)
            //    {
            //        empleados item = this.empleadosel;
        ...
        protected override bool ProcessCmdKey(ref System.Windows.Forms.Message msg, System.Windows.Forms.Keys keyData)
        {
            ...
            frmprovedoresdet frm = new frmprovedoresdet(row.Cells["idproy"].Value.ToString());
            frm.MdiParent = this.MdiParent;
            frm.ShowDialog();
            return true;
        }
        ...
        {
            frmproyectosdet frm = new frmproyectosdet();
            frm.MdiParent = this.MdiParent;
            frm.ShowDialog();
        }
        ...
        {
            frmconflistados frm = new frmconflistados(7);
            frm.ShowDialog();
        }

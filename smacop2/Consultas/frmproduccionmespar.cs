...
{
    public partial class frmproduccionmespar : Form
    {
        public frmproduccionmespar()
        {
            InitializeComponent();
        ...
        private void dataGridView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                frmverificacion frm = new frmverificacion(op_var.a, op_var.b, row.Cells[1].Value.ToString(), this.comboBox1.Text, 7);
        ...
        private void dataGridView2_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                frmverificacion frm;
                    ...
                    frm = new frmverificacion(op_var.a, op_var.b, row.Cells[1].Value.ToString(), this.comboBox1.Text, 8);
                frm.MdiParent = this.MdiParent;
                frm.Show();
            }
            catch (MySqlException ex)
        ...
        {
            comboBox1.DataSource = op_combos.FillCombo("select cod, nom from materiales");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton2.Checked)
            {
              ...
              this.dataGridView1.DataSource = op_entradasmat.GellAllcmat(op_var.a, op_var.b, comboBox1.SelectedValue.ToString()); 

              dataGridView2.AutoGenerateColumns = false;
              this.dataGridView2.DataSource = op_salidasmat.GellAllcmat(op_var.a, op_var.b, comboBox1.SelectedValue.ToString());
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked)
            {
                ...
                dataGridView1.AutoGenerateColumns = false;
                this.dataGridView1.DataSource = op_entradasmat.GellAllcmat(dateTimePicker4.Value, dateTimePicker3.Value, comboBox1.SelectedValue.ToString());

                dataGridView2.AutoGenerateColumns = false;
                this.dataGridView2.DataSource = op_salidasmat.GellAllcmat(dateTimePicker4.Value, dateTimePicker3.Value, comboBox1.SelectedValue.ToString());
            }
